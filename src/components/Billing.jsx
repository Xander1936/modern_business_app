    ...
    <section id='product' className={layout.sectionReverse} >
      ...
      <div className={layout.sectionInfo}>
        ...
        <p className={`${styles.paragraph} max-w-[470px] mt-5`} >
          Elitr eirmod ipsum ipsum invidunt
          sed. Dolore Amet nonumy labore no et voluptua. 
          Ipsum sed gubergr accusam tempor eos ut.Stet diam lorem sanctus sanctus et et sit sit ut.
        </p>
